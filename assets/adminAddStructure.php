...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <div class="card" >
    <form action="index.php?page=adminRegistStructure" method= 'post'>
  <div class="form-group">
    <label for="exampleFormControlInput1" >Nom Struture</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="structure"name="name">
  </div>
  <div class="form-group">
